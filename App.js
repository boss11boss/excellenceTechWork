...
class App extends Component {
  ...
  state={
    cards:[
      {id:'kdjsfb1',name:"Mailchimp",description:'The all-in-one Marketing Platform built for growing businesses.'},
      {id:'qlo@fb1',name:"AdomasAleno",description:'m an owner of a digital product design studio Bettr. I love UI, UX and taking photos. Feel free to use my photos for your own project'}
    ],
    newPost:false,
